...
* **Penjelasan Celah Kode:**  
  Payload `<script>alert('XSS Reflected')</script>` langsung dieksekusi oleh browser saat disubmit via URL. Celah ini terjadi karena nilai masukan langsung dirender ke halaman HTML tanpa melalui proses *HTML escaping*.
